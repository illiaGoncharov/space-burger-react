...
import { AppProps } from '../BurgerIngredients/BurgerIngredients'

function BurgerConstructor(props: any) {
    const totalSum = props.construct.reduce((acc: any, item: AppProps) => acc + item.price, 0)
    return (
        <section className={`${ConstructorStyles.constructor} mt-25`}>
            ...
            <section className={`${ConstructorStyles.constructor__totalsum} mt-10`}>
                <div className={ConstructorStyles.constructor__wrap}>
                    ...
                    <span><svg width="34" height="32" viewBox="0 0 34 32" fill="none" xmlns="http://www.w3.org/2000/svg">
